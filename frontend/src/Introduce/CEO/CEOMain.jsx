      ...
      <div className="ceo-section">
        ...
        <div className="ceo-container" data-aos="fade-left" data-aos-delay="200">
          <div className="ceo-text">
            ...
            <p-ceo className="ceo-message" data-aos="fade" data-aos-delay="300">
            ...
            <p-ceo className="ceo-message" data-aos="fade" data-aos-delay="500">
            ...
            <h3 className="ceo-name" data-aos="fade-up" data-aos-delay="700">새한그룹 회장 김원만</h3>
          </div>
        </div>
      </div>
    </section>
