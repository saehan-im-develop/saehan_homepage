...
const ImageTextRight = ({ image, title, number, date, description }) => {
  return (
    <div className="image-text-container image-text-right"> {/* 🟦 개별 클래스 부여 */}
      <div className="image-wrapper" id="res-img-left">
        <img src={image} alt="기술 이미지" className="image"  />
      </div>
      <div className="text-box overlay overlay-tech1"> {/* 🟦 고유 클래스 적용 */}
        <h3>{title}</h3>
